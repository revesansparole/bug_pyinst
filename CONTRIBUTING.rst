...
**nitrogen_ferti** could always use more documentation, whether as
part of the official **nitrogen_ferti** docs, in docstrings, or even
...
Ready to contribute? Here's how to set up `nitrogen_ferti` for local
development.

1. Fork the `nitrogen_ferti` repo on 
gitlab.itkweb.fr.
2. Clone your fork locally::

    $ git clone git@gitlab.itkweb.fr:your_name_here/nitrogen_ferti.git
...
tests, including testing other Python versions with tox::
    ...
    (dvlpt)$ cd nitrogen_ferti
    (dvlpt) nitrogen_ferti$ flake8
    (dvlpt) nitrogen_ferti$ pytest
    
    (dvlpt) nitrogen_ferti$ tox
...
.. _issues: https://gitlab.itkweb.fr/agro/nitrogen_ferti/issues
